...
export default defineEventHandler(async (event) => {
  try {
    ...
    if (
      ...
      !totalCoverage ||
      !costPerMonth ||
      allowLessCoverage === null ||
      allowLessCoverage === undefined
    ) {
    ...
    await customerAddsServiceMatchScoreCalculation(newInsuranceService.id, newInsuranceService.serviceType);
